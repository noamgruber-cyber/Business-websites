  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-white/[0.07]">
            ...
            <span className="text-white/20 text-xs hidden sm:block">
              {text.stepOf} {currentStep} {text.of} 5
            </span>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 end-5 z-40 flex items-center gap-2 px-4 py-2.5 rounded-full bg-purple-600 hover:bg-purple-500 text-white text-sm font-semibold shadow-xl shadow-purple-500/40 transition-all duration-200"
      >
