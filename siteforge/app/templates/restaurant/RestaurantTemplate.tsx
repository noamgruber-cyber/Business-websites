...
export default function RestaurantTemplate({ business }: Props) {
  ...
  return (
    <div style={{ overflowX: 'hidden', fontFamily: "'Inter', sans-serif" }}>
      ...
      <RestaurantMenu    business={business} />
      <RestaurantGallery business={business} />
      <RestaurantContact business={business} />
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="font-playfair italic text-white/40 text-sm mb-6">
            {business.tagline}
          </p>
          ...
          {/* Divider */}
          <div className="w-16 h-px mx-auto mb-6" style={{ backgroundColor: RED + '50' }} />
